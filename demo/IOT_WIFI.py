...
h1 = Label(root,text="HG 物联网平台",bg="orange",fg="black",font= ('verdana',13,'bold'))
h1.place(x=135,y=5)
...
e = Label(root,text="SSID",font= ('verdana',10,'bold'))
e.place(x=100,y=130)
email = Entry(root,width=30,relief=RIDGE,borderwidth=3)
email.place(x=100,y=150)

p = Label(root,text="密码",font= ('verdana',10,'bold'))
p.place(x=100,y=190)
password = Entry(root,width=30,relief=RIDGE,borderwidth=3)
password.place(x=100,y=210)

c = Label(root,text="发送次数",font= ('verdana',10,'bold'))
c.place(x=100,y=250)
counter = Entry(root,width=30,relief=RIDGE,borderwidth=3)
counter.place(x=100,y=270)


login = Button(root,text="连接",padx=30,bg="orange",relief=RIDGE,borderwidth=1,font= ('verdana',10,'bold'),cursor="hand2",command=Login)
login.place(x=135,y=330)
